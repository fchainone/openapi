...
public class BHexConstants {
    ...
    public static final String API_BASE_URL = "https://api.fchain.one/";

    /**
     * Streaming API base URL.
     */
    public static final String WS_API_BASE_URL = "wss://wsapi.fchain.one/openapi/quote/ws/v1";

    public static final String WS_API_USER_URL = "wss://wsapi.fchain.one/openapi/ws/";
